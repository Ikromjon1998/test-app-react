...
function AnswerForm(props) {
    ...
    const handleSubmit = (event) => {
        ...
        if (editableAnswer) {
            // Call the updateAnswer function passed as props to update the answer
            props.updateAnswer(answer);
            // Navigate back to the question's details page
            navigate(`/questions/${questionId}`);
        } else {
            // Call the addAnswer function passed as props to add the answer
            props.addAnswer(answer);
            // Navigate back to the list of questions
            navigate('/questions');
        }
    }
